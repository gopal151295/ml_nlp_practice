...
def classify0(inX, dataSet, labels, k):
    ...
    for i in range(k):
        ...
        classCount[voteIlabel] = classCount.get(voteIlabel, 0) + 1 # Voting with lowest k distance
    sortedClassCount = sorted(classCount.items(), key=operator.itemgetter(1), reverse=True) # Sort Disctonary
